...
def parse_args():
    ...
    parser.add_argument("--ncpus", default=10, type=int, help="Number of cpus per gpu")
    ...
    parser.add_argument('--name', default="mae", type=str, help="Name for job")
...
def main():
    ...
    executor.update_parameters(
        ...
        cpus_per_task=num_cpus_per_gpu,
        nodes=nodes,
